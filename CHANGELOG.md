...
- Hardened Unity database and slot names against `.` and `..` path segments.
- Added security notes covering local tampering, checksum scope, raw path usage, and serializer responsibility.
